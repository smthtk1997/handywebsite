                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">แก้ไขข้อมูลรถยนต์</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4" id="display_img1" style="margin: auto;">
                            <div class="i-am-centered" style="margin-bottom: 30px;">
                                <img id="preview_img" class="centerOfRow rounded-circle" src="{{$car->img_path != null ? url('/files/user_car_img/'.$car->img_path):url('/files/user_car_img/'.$array_img[$rand])}}" alt="car_img" style="object-fit: cover;width: 200px;height: 200px;border-radius: 50%">
                        ...
                        @if ($car)
                            <div class="col-12 col-md-8" id="form_tag">
                                {!! Form::open(['method' => 'post','route'=>['fuellog.app.edit.car.update','car'=>$car->token],'files' => true]) !!}
                                <div class="form-row" style="margin-bottom: 20px">
                                    <div class="form-group col-12 col-md-6">
                                        <label for="carName">ชื่อรถ</label>
                                        <input type="text" id="carName" class="mt-1 mb-1 form-control" name="carName" value="{{$car->name}}" required>
{{--                                        <input type="hidden" name="no_img" value="{{$array_img[$rand]}}">--}}
                                    </div>
                                    <div class="form-group col-12 col-md-6">
                                        <label for="carLicense">เลขทะเบียน</label>
                                        <input type="text" id="carLicense" class="mt-1 mb-1 form-control" name="carLicense" value="{{$car->license}}" required>
                                    </div>
                                        ...
                                        <select id="brand" class="form-control" name="brand" required>
                                            ...
                                            @foreach($brands as $brand)
                                                @if ($car->brand_id == $brand->id)
                                                    <option value="{{$brand->id}}" data-img="{{$brand->img_logo}}" selected>{{ucfirst($brand->name)}}</option>
                                                    @else
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="text" id="modelCar" class="mt-1 mb-1 form-control" name="modelCar" value="{{$car->model}}" required disabled>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6" style="margin-top: 0.25rem;">
                                        ...
                                        <small class="text-danger">หากต้องการเปลี่ยนรูป กรุณาอัพโหลดไฟล์ใหม่.</small>
                                    </div>
                                </div>
